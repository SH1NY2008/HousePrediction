...
export const DraggableCardBody = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "relative min-h-96 w-80 overflow-hidden rounded-md bg-gray-900/50 border border-gray-700 p-6 shadow-2xl transform-3d cursor-grab active:cursor-grabbing",
        className,
      )}
    >
      {children}
      <motion.div
        ...
        className="pointer-events-none absolute inset-0 bg-gradient-to-r from-[#00BFB2]/10 to-[#028090]/10 select-none"
      />
    </motion.div>
  )
}
